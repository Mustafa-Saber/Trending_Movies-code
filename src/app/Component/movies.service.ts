...
export class MoviesService {
  ...
  getMoives(movieType: string): Observable<any> {
    return this._HttpClient.get(
      `https://api.themoviedb.org/3/trending/${movieType}/week?api_key=c8c85c867880ce8e782367dd70475e2d`
    );
  }
  ...
  getmovieDetails(id: string, media_type: string): Observable<any> {
    return this._HttpClient.get(
      `https://api.themoviedb.org/3/${media_type}/${id}?api_key=c8c85c867880ce8e782367dd70475e2d&language=en-US`
    );
  }
}
